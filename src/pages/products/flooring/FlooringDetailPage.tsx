...
const FlooringDetailPage: React.FC = () => {
  ...
  if (!slug || notFound) return <Navigate to="/products/flooring" replace />;
  ...
  if (!product) return <Navigate to="/products/flooring" replace />;
  ...
  return (
    <ProductDetailLayout
      ...
      seoTags={['Premium Flooring', 'Luxury Vinyl', 'Hardwood']}
    />
  );
};
