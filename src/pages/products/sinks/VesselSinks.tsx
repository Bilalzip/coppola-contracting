...
const VesselSinks = () => {
  ...
  useEffect(() => {
    document.title = 'Vessel Sinks | Coppola Home';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4 max-w-3xl">
            ...
            <p className="text-base sm:text-lg text-neutral-600 leading-relaxed">
              Statement pieces for distinctive bathroom design. Artistic fixtures that transform your space.
            </p>
          </div>
        </div>
      </section>
          ...
          {loading ? (
            ...
            <div className="text-center py-20">
              <div className="max-w-md mx-auto space-y-4">
                <p className="text-xl font-serif text-neutral-900">No vessel sinks found</p>
      ...
      <section className="py-16 md:py-20 bg-neutral-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-serif text-neutral-900">
            Need help choosing the perfect vessel sink?
          </h2>
